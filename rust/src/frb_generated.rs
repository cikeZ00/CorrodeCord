...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -128382460;
...
fn wire__crate__api__main__gateway_connection_impl(
                ...
                transform_result_sse::<_, ()>(
                    (move || async move {
                        let output_ok = Result::<_, ()>::Ok({
                            crate::api::main::gateway_connection(api_token, api_sink).await;
                        })?;
                        Ok(output_ok)
                    })()
                    .await,
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__main__gateway_connection_impl(port, ptr, rust_vec_len, data_len),
